    ...
    OnTaurusModelError
{
    ...
    if (task === TASK_UPDATE_JOB_STATUS) {
      this.toastService.show({
        ...
        description:
          ...
          `${!this._extractJobDeployment()?.enabled ? "enabled" : "disabled"}`,
      });
    ...
    if (state.getData<"explore" | "manage">("context") === "explore") {
      if (this.dataPipelinesModuleConfig.exploreConfig) {
        this.shouldShowTeamsSection =
          this.dataPipelinesModuleConfig.exploreConfig.showTeamSectionInJobDetails;
        this.shouldShowChangeHistorySection =
          this.dataPipelinesModuleConfig.exploreConfig.showChangeHistorySectionInJobDetails;
      }
    } else {
      if (this.dataPipelinesModuleConfig.manageConfig) {
        this.shouldShowTeamsSection =
          this.dataPipelinesModuleConfig.manageConfig.showTeamSectionInJobDetails;
        this.shouldShowChangeHistorySection =
          this.dataPipelinesModuleConfig.manageConfig.showChangeHistorySectionInJobDetails;
      }
    }
  }
  ...
  private _initializeChangeHistoryConfig(): void {
    ...
    this.changeHistoryConfig = {
      ...this.dataPipelinesModuleConfig.changeHistory,
      urlTemplate: CollectionsUtil.interpolateString(
        this.dataPipelinesModuleConfig.changeHistory.urlTemplate,
        {
