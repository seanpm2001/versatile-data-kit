 ...
 */
export class ExecutionDefaultComparator
  implements Comparator<GridDataJobExecution>
{
  ...
  compare(exec1: GridDataJobExecution, exec2: GridDataJobExecution) {
    const value1 = get<GridDataJobExecution, keyof GridDataJobExecution>(
      exec1,
      this.property,
    );
    const value2 = get<GridDataJobExecution, keyof GridDataJobExecution>(
      exec2,
      this.property,
    );
