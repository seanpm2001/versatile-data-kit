 ...
 */
export class ExecutionsStatusCriteria
  implements Criteria<GridDataJobExecution>
{
  ...
  constructor(dataJobExecutionStatusesSerialized: string) {
    this._dataJobExecutionStatuses =
      ExecutionsStatusCriteria._deserializeExecutionStatuses(
        dataJobExecutionStatusesSerialized,
      );
  }
  ...
  private static _deserializeExecutionStatuses(
    dataJobExecutionStatusesSerialized: string,
  ): DataJobExecutionStatus[] {
    try {
      if (
        !CollectionsUtil.isStringWithContent(dataJobExecutionStatusesSerialized)
      ) {
        return [];
      }

      return dataJobExecutionStatusesSerialized
        .toUpperCase()
        .split(",") as DataJobExecutionStatus[];
    } catch (e) {
      console.error(
