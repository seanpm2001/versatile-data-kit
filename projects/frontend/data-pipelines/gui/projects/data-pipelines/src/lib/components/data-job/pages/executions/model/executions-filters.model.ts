 ...
 */
export type ExecutionsFilterPairs<K extends string = ExecutionsFilterCriteria> =
  KeyValueTuple<K, string>;

/**
 * ** Executions grid filter with its value.
 */
export type ExecutionsGridFilter<K extends string = ExecutionsFilterCriteria> =
  { property: K; value: string };
 ...
 */
export type ExecutionsSortPairs = KeyValueTuple<
 ...
 */
export type ExecutionsFilterSortObject = Record<
  typeof FILTER_KEY | typeof SORT_KEY,
  string
>;
