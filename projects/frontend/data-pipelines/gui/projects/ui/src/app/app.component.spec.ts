...
describe("AppComponent", () => {
  ...
  beforeEach(() => {
    ...
    appConfigServiceStub = jasmine.createSpyObj<AppConfigService>(
      "appConfigService",
      ["getConfig", "getAuthCodeFlowConfig", "getSkipAuth"],
    );
    ...
    urlOpenerServiceStub = jasmine.createSpyObj<UrlOpenerService>(
      "urlOpenerServiceStub",
      ["initialize"],
    );
  ...
  it("should create the app with auth enabled", () => {
    ...
    const oAuthServiceStub = jasmine.createSpyObj<OAuthService>(
      "oAuthService",
      [
        "configure",
