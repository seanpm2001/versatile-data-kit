 ...
 * ** Taurus Route config.
 */
export interface TaurusRoute<T extends TaurusRouteData = TaurusRouteData>
  extends Route {
  /**
   * @inheritDoc
   *
 ...
 */
export type TaurusRoutes<T extends TaurusRouteData = TaurusRouteData> =
  TaurusRoute<T>[];
