...
describe("CopyToClipboardButtonComponent", () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [TestHostComponent, VdkCopyToClipboardButtonComponent],
    });
  });
...
@Component({
  template: `
    <vdk-copy-to-clipboard-button [value]="value">
    </vdk-copy-to-clipboard-button>
  `,
})
class TestHostComponent {
  @ViewChild(VdkCopyToClipboardButtonComponent, { static: true })
  component: VdkCopyToClipboardButtonComponent;
