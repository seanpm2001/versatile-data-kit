...
@Component({
  ...
  animations: [
      ...
      transition(
        ...
        [
          group([
            ...
            query(
              ".toast-description, .toast-title, .icon, .button-container, .dismiss-bg, .dismiss, .toast-date",
              [
                animate(
                  `${multiply(10)}ms`,
                  style({
    ...
    trigger("infoLine", [
      transition("* => *", [
        animate(
          `${multiply(linePrimaryEnterTiming)}ms ${multiply(
            linePrimaryEnterDelay,
          )}ms ${linePrimaryEnterCurve}`,
          keyframes([
    ...
    trigger("infoDot", [
      transition("* => *", [
        ...
        animate(
          `${multiply(lineSecondaryEnterTiming)}ms ${multiply(
            lineSecondaryEnterDelay,
          )}ms ${lineSecondaryEnterCurve}`,
          style({
            transform: "scale(1)",
          }),
        ),
    ...
    trigger("gradientMove", [
      transition("* => *", [
        ...
        animate(
          `${multiply(GRADIENT_DURATION)}ms ${multiply(
            GRADIENT_DELAY,
          )}ms ${GRADIENT_LEAVE_CURVE}`,
          style({
            transform: "scale(0, 1)",
          }),
        ),
    ...
    trigger("dismissIconVisible", [
      transition("* => *", [
        ...
        animate(
          `${multiply(DISMISS_ICON_DURATION)}ms ${multiply(
            DISMISS_ICON_DELAY,
          )}ms ${DISMISS_ICON_CURVE}`,
          style({
            opacity: "1",
          }),
        ),
