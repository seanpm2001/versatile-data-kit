...
// eslint-disable-next-line @angular-eslint/component-class-suffix
class TaurusBaseComponentStubV1
  extends TaurusBaseComponentStub
  implements OnTaurusModelInitialLoad, OnTaurusModelError
{
  ...
  describe("Methods::", () => {
    ...
    describe("|bindModel|", () => {
      ...
      it("should verify will invoke correct Taurus lifecycle hooks for FAILED and modified", () => {
        // Given
        spyOn(TaurusBaseComponentStubV1.prototype, "onModelInit").and.callFake(
          CallFake,
        );
        spyOn(
          TaurusBaseComponentStubV1.prototype,
          "onModelInitialLoad",
        ).and.callFake(CallFake);
        spyOn(TaurusBaseComponentStubV1.prototype, "onModelLoad").and.callFake(
          CallFake,
        );
        spyOn(
          TaurusBaseComponentStubV1.prototype,
        ...
        const component1: TaurusBaseComponentStubV1 = TestBed.createComponent(
          TaurusBaseComponentStubV1,
        ).componentInstance;
        ...
        // Then
        expect(onModelErrorSpy.calls.argsFor(0)).toEqual([
          modelStub1,
          undefined,
          [],
        ]);
        expect(onModelErrorSpy.calls.argsFor(1)).toEqual([
          modelStub2,
          undefined,
          [errorRecord1],
        ]);
        expect(onModelErrorSpy.calls.argsFor(2)).toEqual([
          modelStub3,
          undefined,
          [errorRecord2, errorRecord3],
        ]);
        expect(onModelErrorSpy.calls.argsFor(3)).toEqual([
          modelStub4,
          undefined,
          [],
        ]);
      ...
      it("should verify will invoke correct Taurus lifecycle hooks for FAILED and modified with Task", () => {
        ...
        const onModelInitialLoadSpy = spyOn(
          TaurusBaseComponentStubV1.prototype,
          "onModelInitialLoad",
        ).and.callFake(CallFake);
        const onModelLoadSpy = spyOn(
      ...
      it("should verify will invoke correct Taurus lifecycle hooks for LOADED and not modified", () => {
        ...
        expect(component.model).toBe(modelStub);
        expect(onModelInitSpy).toHaveBeenCalledWith(modelStub, undefined);
        expect(onModelFirstLoadSpy).toHaveBeenCalledWith(
          localModelStub,
          undefined,
        );
      ...
      it("should verify Taurus lifecycle hook will throw/catch error and log it to console", () => {
        ...
        expect(spyError).toHaveBeenCalledWith(
          `Taurus NgRx Redux failed to execute lifecycle hook "onModelChange"!`,
          error,
        );
        expect(onModelFailSpy).not.toHaveBeenCalled();
      });
      ...
      it("should verify Taurus lifecycle hook post normalize will throw/catch error and log it to console", () => {
        ...
        expect(onModelChangeSpy).toHaveBeenCalledWith(modelStub, undefined);
        expect(spyError).toHaveBeenCalledWith(
          `Taurus NgRx Redux failed to normalize ComponentModel!`,
          error,
        );
        expect(onModelFailSpy).not.toHaveBeenCalled();
      });
    ...
    describe("|setStateIdle|", () => {
      it("should verify will invoke correct methods", () => {
        ...
        const prepareForDestroySpy = spyOn(
          modelStub,
          "prepareForDestroy",
    ...
    describe("|refreshModel|", () => {
      it("should verify will assign previous model until depth 3", () => {
        ...
        const modelStub5: ComponentModel = new ComponentModelStub(
          null,
          5,
        ) as any;
        const modelStub6: ComponentModel = new ComponentModelStub(
          null,
          6,
        ) as any;
        ...
        expect(component.model.previousModel.previousModel.previousModel).toBe(
          modelStub3,
        );
        expect(
          component.model.previousModel.previousModel.previousModel
            .previousModel,
        ).toBeUndefined();
      });
      ...
      it("should verify will throw/catch error and log to console", () => {
        // Given
        const error = new Error("Random Error");
        const modelStub1: ComponentModel = new ComponentModelStubV1(
          null,
          1,
        ) as any;
        const modelStub2: ComponentModel = new ComponentModelStubV1(
          null,
          2,
        ) as any;
        ...
        expect(consoleSpy).toHaveBeenCalledWith(
          "Failed to clean previous ComponentModel",
          error,
        );
      });
    });
    ...
    describe("|initializeRouteReuse|", () => {
      it("should verify if route change event is fired will bind new model", () => {
        // Given
        const componentFixture1 = TestBed.createComponent(
          TaurusBaseComponentStubV1,
        );
        ...
        // @ts-ignore
        const spySetStateIdle = spyOn(
          component1,
          "setStateIdle",
        ).and.callThrough();

        component1.model = modelStub1;
        componentServiceStub.init.and.returnValues(
          of(modelStub1),
          of(modelStub2),
        );
        componentServiceStub.getModel.and.returnValues(
          of(modelStub1),
          of(modelStub2),
        );
