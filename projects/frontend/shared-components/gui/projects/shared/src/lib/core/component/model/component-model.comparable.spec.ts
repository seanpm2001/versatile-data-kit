...
import { ComparableImpl, generateErrorCode } from "../../../common";
...
describe("ComponentModelComparable", () => {
  ...
  describe("Methods::", () => {
    ...
    beforeEach(() => {
      ...
      modelComparable = ComponentModelComparable.of(
        ComponentModel.of(componentState, routerState),
      );
    });
    ...
    describe("|compare|", () => {
      it("should verify will return -1 when stored comparable value is not instance of ComponentModel", () => {
        ...
        // When
        const compareV = modelComparable.compare(
          ComponentModelComparable.of(undefined),
        );
      ...
      it("should verify will return -1 when provided comparable is not instance of expected", () => {
        // When
        const compareV = modelComparable.compare(
          ComponentModelComparable.of(null),
        );
      ...
      it("should verify will return 0 when ComponentModel ref is same", () => {
        ...
        modelComparable.value
          .getComponentState()
          .uiState.set("submitBtn", { state: "submitted" });
      ...
      it("should verify will return -1 when status is different", () => {
        ...
        const modelComparableDI = ComponentModelComparable.of(
          ComponentModel.of(componentStateComparable, routerState),
        );
      ...
      it("should verify will return 0 when navigationId is different", () => {
        // Given
        const routerStateComparable = RouterState.of(routerState.state, 90);
        const modelComparableDI = ComponentModelComparable.of(
          ComponentModel.of(componentState, routerStateComparable),
        );
      ...
      it("should verify will return -1 when error is different", () => {
        ...
        const publicName = CollectionsUtil.generateRandomString();
          ...
          errors: ErrorStoreImpl.of([
            {
              ...
              code: generateErrorCode(className, publicName, "load", "503"),
              objectUUID,
              httpStatusCode: 503,
              time: Date.now(),
            },
      ...
      it("should verify will return 0 when ref is different but content is same", () => {
        ...
        // Then
        expect(compareV).toEqual(0);
        expect(areMapsEqualSpy).toHaveBeenCalledWith(
          componentState.data,
          componentStateComparable.data,
        );
      });
