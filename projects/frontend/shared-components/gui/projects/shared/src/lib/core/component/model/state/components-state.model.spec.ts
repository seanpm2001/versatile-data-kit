...
describe("ComponentsStateHelper", () => {
  ...
  describe("Methods::", () => {
    ...
    describe("|getLiteralComponentState|", () => {
      ...
      it("should verify will return null if there is no such state v1", () => {
        // When
      ...
      it("should verify will return null if there is no such state v2", () => {
        // When
        const state = helper.getLiteralComponentState("component10");
    ...
    describe("|getAllComponentState|", () => {
      ...
      it("should verify will return Array of all ComponentState in given base routePathSegments", () => {
        // When
        const states = helper.getAllComponentState(null);

        // Then
        expect(states.length).toEqual(2);
        expect(states).toEqual([componentState1, componentState3]);
      });
    });
