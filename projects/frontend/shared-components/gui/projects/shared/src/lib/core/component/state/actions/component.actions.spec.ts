...
describe("ComponentActions", () => {
  ...
  describe("ComponentLoading", () => {
    it("should verify instance is created", () => {
      // Then
      expect(
        () => new ComponentLoading(ComponentStateImpl.of({})),
      ).toBeDefined();
    });
  ...
  describe("ComponentLoaded", () => {
    it("should verify instance is created", () => {
      // Then
      expect(
        () => new ComponentLoaded(ComponentStateImpl.of({})),
      ).toBeDefined();
    });
  ...
  describe("ComponentFailed", () => {
    it("should verify instance is created", () => {
      // Then
      expect(
        () => new ComponentFailed(ComponentStateImpl.of({})),
      ).toBeDefined();
    });
  ...
  describe("ComponentUpdate", () => {
    it("should verify instance is created", () => {
      // Then
      expect(
        () => new ComponentUpdate(ComponentStateImpl.of({})),
      ).toBeDefined();
    });
  ...
  describe("ComponentClearData", () => {
    it("should verify instance is created", () => {
      // Then
      expect(
        () => new ComponentClearData(ComponentStateImpl.of({})),
      ).toBeDefined();
    });
