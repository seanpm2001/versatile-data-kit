      ...
      marbles((m) => {
        ...
        const getModelStream1$ = m.cold("-a", {
          a: ComponentModel.of(
            ...
            RouterState.of(
              RouteState.of(RouteSegments.of("entity/10"), "entity/5"),
              3,
            ),
          ),
        });
        const getModelStream2$ = m.cold("--a", {
          a: ComponentModel.of(
            ...
            RouterState.of(
              RouteState.of(RouteSegments.of("entity/225"), "entity/225"),
              3,
            ),
          ),
        });
        ...
        const componentServiceStub = jasmine.createSpyObj<ComponentService>(
          "componentService",
          ["getModel"],
        );
        let cnt = 0;
  ...
  describe("|getModelAndTask|", () => {
    it(
      ...
      marbles((m) => {
        ...
        spyOn(CollectionsUtil, "interpolateString").and.returnValues(
          taskIdentifier1,
          taskIdentifier2,
        );
        const inputActionStream$ = m.cold("----a---b----", {
        ...
        // When
        const response$ =
          getModelAndTask(componentServiceStub)(inputActionStream$);
  ...
  describe("|handleActionError|", () => {
    it(
      ...
      marbles((m) => {
        ...
        const serviceStub = jasmine.createSpyObj<{ load: () => void }>(
          "serviceStub",
          ["load"],
        );
        ...
        // When
        const response$ = handleActionError(() => [
          inputModel,
          taskName,
          objectUUID,
          errorCodes.load,
