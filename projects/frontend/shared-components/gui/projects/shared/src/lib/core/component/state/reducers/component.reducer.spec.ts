...
describe("componentReducer", () => {
  ...
  beforeEach(() => {
    ...
    updateComponentHelperSpy = spyOn(
      ComponentsStateHelper.prototype,
      "updateLiteralComponentState",
    ).and.callFake(CallFake);
    getComponentHelperSpy = spyOn(
      ComponentsStateHelper.prototype,
  ...
  describe("Actions::", () => {
    describe("|COMPONENT_INIT|", () => {
      it("should verify invokes correct methods", () => {
        ...
        const action = new ActionStub<ComponentState>(
          COMPONENT_INIT,
          createComponentState(null),
        );
        getStateHelperSpy.and.returnValue(
          createComponentsState(createComponentState(INITIALIZED).toLiteral()),
        );
        ...
        expect(updateComponentHelperSpy).toHaveBeenCalledWith(
          createComponentState(INITIALIZED).toLiteral(),
        );
      });
    });
    ...
    describe("|COMPONENT_IDLE|", () => {
      it("should verify invokes correct methods", () => {
        // Given
        const action = ComponentIdle.of(
          createComponentState(INITIALIZED, "test-team", 4),
        );
        getComponentHelperSpy.and.returnValue(
          createComponentState(INITIALIZED).toLiteral(),
        );
        getStateHelperSpy.and.returnValue(
          createComponentsState(
            createComponentState(IDLE, "test-team", 4).toLiteral(),
          ),
        );
        ...
        // Then
        expect(getComponentHelperSpy).toHaveBeenCalledWith(
          id,
          routePathSegments,
        );
        expect(result).toEqual(
    ...
    describe("|COMPONENT_LOADING|", () => {
      it("should verify invokes correct methods", () => {
        ...
        const action = new ActionStub<ComponentState>(
          COMPONENT_LOADING,
          createComponentState(IDLE, "test-team", 4),
        );
        getComponentHelperSpy.and.returnValue(
          createComponentState(IDLE).toLiteral(),
        );
        getStateHelperSpy.and.returnValue(
          createComponentsState(
            createComponentState(LOADING, "test-team", 4).toLiteral(),
          ),
        );
    ...
    describe("|COMPONENT_UPDATE|", () => {
      it("should verify invokes correct methods (data from action)", () => {
        ...
        getComponentHelperSpy.and.returnValue(
          createComponentState(LOADING).toLiteral(),
        );
        getStateHelperSpy.and.returnValue(
          createComponentsState(
      ...
      it("should verify invokes correct methods (data from store)", () => {
        ...
        getComponentHelperSpy.and.returnValue(
          createComponentState(LOADING, "test-team", 4, data).toLiteral(),
        );
        getStateHelperSpy.and.returnValue(
          createComponentsState(
    ...
    describe("|COMPONENT_LOADED|", () => {
      it("should verify invokes correct methods", () => {
        // Given
        const action = ComponentLoaded.of(
          createComponentState(LOADING, "test-team", 11),
        );
        getComponentHelperSpy.and.returnValue(
          createComponentState(IDLE, "test-team", 7).toLiteral(),
        );
        getStateHelperSpy.and.returnValue(
          createComponentsState(
    ...
    describe("|COMPONENT_FAILED|", () => {
      ...
      it("should verify invokes correct methods (data from store)", () => {
        ...
        getComponentHelperSpy.and.returnValue(
          createComponentState(LOADING, "test-team", 14, data).toLiteral(),
        );
        getStateHelperSpy.and.returnValue(
          createComponentsState(
    ...
    describe("|COMPONENT_CLEAR_DATA|", () => {
      it("should verify invokes correct methods", () => {
        ...
        getComponentHelperSpy.and.returnValue(
          createComponentState(LOADED, "test-team", 15, data).toLiteral(),
        );
        getStateHelperSpy.and.returnValue(
          createComponentsState(
    ...
    describe("|ROUTER_NAVIGATION|", () => {
      it("should verify invokes correct methods", () => {
        ...
        const resetComponentsHelperSpy = spyOn(
          ComponentsStateHelper.prototype,
        ...
        // Then
        expect(resetComponentsHelperSpy).toHaveBeenCalledWith(
          routerNavigationPayload.routerState.routePathSegments,
        );
        expect(result).toEqual(
          createComponentsState(
            createComponentState(IDLE, "test-team", 17).toLiteral(),
...
const createComponentsState = (
  componentState: LiteralComponentState,
): LiteralComponentsState => {
  return {
    components: {},
    routePathSegments: {
...
const createRouterNavigationPayload =
  (): RouterNavigationPayload<RouteState> => {
    return {
      routerState: RouteState.of(RouteSegments.of("entity/21"), "entity/21"),
      event: null,
    };
  };
