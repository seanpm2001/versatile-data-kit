...
export class VdkSharedNgRxModule {
   ...
   *      - In FeaturesModules (lazy loaded Modules) invoke one of the methods <b>forFeatureEffects/forFeatureStore</b>.
   */
  static forRootWithDevtools(
    config: TaurusNgRxConfig = {},
  ): ModuleWithProviders<VdkSharedNgrxDevModule> {
  ...
  static forFeatureEffects(
    effects: Array<Type<any>>,
