...
describe("Route Classes", () => {
      ...
      describe("Methods::", () => {
        describe("|of|", () => {
          it("should verify factory method will create instance", () => {
            // When
            const instance = RouteSegments.of(
              "domain/context",
              {},
              {},
              null,
    ...
    describe("Getters/Setters::", () => {
      describe("|GET -> routePathSegments|", () => {
        it("should verify will return routePathSegments", () => {
          ...
          // Then
          expect(routePathSegments).toEqual([
            "domain/context",
            "entity/17/explore",
            "bill/105/view",
          ]);
      ...
      describe("|GET -> configPathSegments|", () => {
        it("should verify will return configPathSegments", () => {
          ...
          // Then
          expect(configPathSegments).toEqual([
            "domain/context",
            "entity/:entityId/explore",
            "bill/:billId/view",
          ]);
  ...
  describe("RouteState", () => {
    ...
    it("should verify instance is created", () => {
      ...
      const instance = new RouteState(
        new RouteSegments("domain/context", {}, {}, null, null),
        "domain/context",
      );
    ...
    describe("Getters/Setters::", () => {
      ...
      describe("|GET -> absoluteConfigPath|", () => {
        it("should verify will return absoluteConfigPath", () => {
          ...
          // Then
          expect(absoluteConfigPath).toEqual(
            "/domain/context/entity/:entityId/explore/bill/:billId/view",
          );
        });
      });
    ...
    describe("Methods::", () => {
      describe("|serializeQueryParams|", () => {
        it("should verify will serialize queryParams in string", () => {
          ...
          expect(query).toEqual(
            "test_search*=%5Etest-team%24&test_%40active-user=%25aUser%25",
          );
        });
      ...
      describe("|getData|", () => {
        it("should verify will invoke correct methods", () => {
          // Given
          const getDataSpy = spyOn(
            RouteSegments.prototype,
            "getData",
      ...
      describe("|getParam|", () => {
        it("should verify will invoke correct methods", () => {
          // Given
          const getParamSpy = spyOn(
            RouteSegments.prototype,
            "getParam",
          ).and.returnValue("test-value");
      ...
      describe("|getParentAbsoluteRoutePath|", () => {
        it("should verify will return correct value", () => {
          // When
          const parentAbsoluteRoutePath =
            routeState.getParentAbsoluteRoutePath();

          // Then
          expect(parentAbsoluteRoutePath).toEqual(
            "/domain/context/entity/17/explore",
          );
        });
      });
      ...
      describe("|toJSON|", () => {
        it("should verify will return correct object for serialization", () => {
          ...
          expect(objForSerialize).toEqual({
            ...
            queryParams: {
              "test_search*": "^test-team$",
              "test_@active-user": "%aUser%",
            },
          });
        });
      });
  ...
  describe("RouterState", () => {
    ...
    beforeEach(() => {
      ...
      routerState = RouterState.of(routeState, 15);

      previousRouterState = RouterState.of(RouteState.empty(), 14);
      previousRouterState.previousStates.push(
        RouterState.of(RouteState.empty(), 13),
        RouterState.of(RouteState.empty(), 12),
    ...
    describe("Methods::", () => {
      ...
      describe("|appendPrevious|", () => {
        ...
        it("should verify will pop the oldest one and will unshift the new one when buffer has 10 elements", () => {
          // Given
          previousRouterState.previousStates.push(
            RouterState.of(RouteState.empty(), 10),
            RouterState.of(RouteState.empty(), 9),
            RouterState.of(RouteState.empty(), 8),
            RouterState.of(RouteState.empty(), 7),
            RouterState.of(RouteState.empty(), 6),
        ...
        it(`should verify won't add new state when previousState has same navigationId like current`, () => {
          // Given
          routerState = RouterState.of(RouteState.empty(), 14);
