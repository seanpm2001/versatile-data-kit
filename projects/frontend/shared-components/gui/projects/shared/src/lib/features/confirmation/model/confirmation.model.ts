...
export const ERROR_CODE_CONFIRMATION_FORCEFULLY_DESTROYED_COMPONENT =
  "EC_CONFIRMATION_1000";
 ...
 */
export interface ConfirmationInputModel
  extends SupportedButtonsModel,
    SupportedMessageModel {
  /**
   * ** Confirmation title.
   *
...
export class ConfirmationModelImpl
  implements ConfirmationInputModel, ConfirmationModelExtension
{
  /**
   * @inheritDoc
   */
  ...
  private _assignButtonModelDefaults(
    modelKey: keyof SupportedButtonsModel,
    defaultText: string,
  ): void {
    ...
    if (
      !this[modelKey].iconPosition ||
      (this[modelKey].iconPosition !== "left" &&
        this[modelKey].iconPosition !== "right")
    ) {
