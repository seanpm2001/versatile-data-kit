...
describe("ConfirmationService", () => {
  ...
  let containerComponentRefStub: jasmine.SpyObj<
    ComponentRef<ConfirmationContainerComponent>
  >;

  let confirmationChangeDetectorRefStub: jasmine.SpyObj<ChangeDetectorRef>;
  let confirmationComponentRefStub: jasmine.SpyObj<
    ComponentRef<ConfirmationComponent>
  >;
  ...
  let confirmationMessageComponentRefStub: jasmine.SpyObj<
    ComponentRef<DummyMessageComponent>
  >;
  ...
  beforeEach(() => {
    dynamicComponentsServiceStub =
      jasmine.createSpyObj<DynamicComponentsService>(
        "dynamicComponentsServiceStub",
        ["getUniqueViewContainerRef", "destroyUniqueViewContainerRef"],
      );

    acquiredDynamicViewComponentRef = jasmine.createSpyObj<ViewContainerRef>(
      "acquiredDynamicViewComponentRef",
      ["createComponent", "clear"],
    );
    acquiredDynamicHostViewStub = jasmine.createSpyObj<ViewRef>(
      "acquiredDynamicHostViewStub",
      ["destroy"],
      {
        destroyed: false,
      },
    ...
    containerChangeDetectorRefStub = jasmine.createSpyObj<ChangeDetectorRef>(
      "confirmationContainerChangeDetectorRefStub",
      ["detectChanges"],
    );
    ...
    containerComponentRefStub = jasmine.createSpyObj<
      ComponentRef<ConfirmationContainerComponent>
    >("confirmationContainerComponentRefStub", ["destroy"], {
    ...
    confirmationChangeDetectorRefStub = jasmine.createSpyObj<ChangeDetectorRef>(
      "confirmationComponentChangeDetectorRefStub",
      ["detectChanges"],
    );
    confirmationComponentHostViewStub = jasmine.createSpyObj<ViewRef>(
      "confirmationComponentHostViewStub",
      ["destroy"],
      {
        destroyed: false,
      },
    );
    confirmationComponentViewContainerRefStub =
      jasmine.createSpyObj<ViewContainerRef>(
        "confirmationComponentViewContainerRefStub",
        ["createComponent"],
      );
    confirmationComponentRefStub = jasmine.createSpyObj<
      ComponentRef<ConfirmationComponent>
    >("confirmationComponentRefStub", ["destroy"], {
      changeDetectorRef: confirmationChangeDetectorRefStub,
      instance: {
        model: null,
        doNotShowFutureConfirmation: false,
        viewContainerRef:
          confirmationComponentViewContainerRefStub as ViewContainerRef,
      } as ConfirmationComponent,
      hostView: confirmationComponentHostViewStub,
    });
    confirmationMessageComponentRefStub = jasmine.createSpyObj<
      ComponentRef<DummyMessageComponent>
    >("confirmationMessageComponentRefStub", ["destroy"], {
      instance: {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {
          provide: DynamicComponentsService,
          useValue: dynamicComponentsServiceStub,
        },
        ConfirmationService,
      ],
    });
  ...
  describe("Methods::", () => {
    const setupTestPrerequisites = () => {
      const inputModel: ConfirmationInputModel = {
        title: "Confirm title",
      ...
      acquiredDynamicViewComponentRef.createComponent.and.returnValue(
    ...
    describe("|confirm|", () => {
      const verifyExpectationsInsidePromise = () => {
        expect(containerViewContainerRefStub.indexOf).toHaveBeenCalledWith(
          confirmationComponentHostViewStub,
        );
        expect(containerViewContainerRefStub.remove).toHaveBeenCalledWith(0);

        expect(
          containerChangeDetectorRefStub.detectChanges,
      ...
      const verifyExpectationsOutsidePromise = (
        inputModel: ConfirmationInputModel,
        verifyCreationOnly = false,
      ) => {
        expect(
          dynamicComponentsServiceStub.getUniqueViewContainerRef,
        ).toHaveBeenCalledTimes(1);

        expect(
          acquiredDynamicViewComponentRef.createComponent,
        ).toHaveBeenCalledTimes(1);
        // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
        expect(
          acquiredDynamicViewComponentRef.createComponent,
        ).toHaveBeenCalledWith(ConfirmationContainerComponent as any);

        expect(
          containerViewContainerRefStub.createComponent,
        ).toHaveBeenCalledTimes(1);
        // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
        expect(
          containerViewContainerRefStub.createComponent,
        ).toHaveBeenCalledWith(ConfirmationComponent as any);
        ...
        expect(
          confirmationChangeDetectorRefStub.detectChanges,
        ).toHaveBeenCalledTimes(1);

        expect(containerComponentRefStub.instance.open).toBeTrue();
        expect(confirmationComponentRefStub.instance.model).toBeInstanceOf(
          ConfirmationModelImpl,
        );
        expect(confirmationComponentRefStub.instance.model.title).toEqual(
          inputModel.title,
        );
        expect(confirmationComponentRefStub.instance.model.message).toEqual(
          inputModel.message,
        );
        expect(
          confirmationComponentRefStub.instance.model.messageComponent,
        ).toBeUndefined();
        expect(
          confirmationComponentRefStub.instance.model.messageCode,
        ).toBeUndefined();
      ...
      it("should verify will reject when thrown error when creating ConfirmationContainerComponent", (done) => {
        ...
        acquiredDynamicViewComponentRef.createComponent.and.throwError(
          new Error("Error"),
        );
      ...
      it("should verify will reject when thrown error when creating ConfirmationComponent", (done) => {
        ...
        containerViewContainerRefStub.createComponent.and.throwError(
          new Error("Error"),
        );
      ...
      it("should verify will reject when thrown error when creating component for message inside ConfirmationComponent", (done) => {
        ...
        containerViewContainerRefStub.indexOf.and.returnValue(0);
        confirmationComponentViewContainerRefStub.createComponent.and.throwError(
          new Error("Error"),
        );
        ...
        service
          ...
          .catch((reason) => {
            ...
            expect(
              confirmationComponentViewContainerRefStub.createComponent,
            ).toHaveBeenCalledTimes(1);
            expect(
              confirmationChangeDetectorRefStub.detectChanges,
            ).not.toHaveBeenCalled();
      ...
      it("should verify will render message Component and resolve when handler is resolved", (done) => {
        ...
        containerViewContainerRefStub.indexOf.and.returnValue(0);
        confirmationComponentViewContainerRefStub.createComponent.and.returnValue(
        ...
        expect(
          confirmationComponentViewContainerRefStub.createComponent,
        ).toHaveBeenCalledWith(DummyMessageComponent as any);
        expect(
          containerChangeDetectorRefStub.detectChanges,
        ).toHaveBeenCalledTimes(2);
        expect(
        ...
        expect(
          confirmationComponentRefStub.instance.model.message,
        ).toBeUndefined();
        expect(
          confirmationComponentRefStub.instance.model.messageComponent,
        ).toBeUndefined();
        ...
        expect(
          confirmationMessageComponentRefStub.instance.messageCode,
        ).toEqual("msg_code_100");

        confirmationComponentRefStub.instance.model.handler.confirm({
          doNotShowFutureConfirmation: true,
        });
      });
      ...
      it("should verify will resolve when handler is resolved and on second invoke will acquire and create new reference because of unhealthy state", fakeAsync(() => {
        ...
        const inputModel: ConfirmationInputModel = {
          title: "Confirm title 50",
          message: "Confirm message 50",
        };
        dynamicComponentsServiceStub.getUniqueViewContainerRef.and.returnValue({
          uuid,
          viewContainerRef: acquiredDynamicViewComponentRef,
          hostView: jasmine.createSpyObj<ViewRef>(
            "acquiredDynamicHostViewStub",
            ["destroy"],
            {
              destroyed: true,
        ...
        expect(
          dynamicComponentsServiceStub.destroyUniqueViewContainerRef,
        ).toHaveBeenCalledTimes(1);
        expect(
          dynamicComponentsServiceStub.destroyUniqueViewContainerRef,
    ...
    describe("|ngOnDestroy|", () => {
      ...
      it("should verify will try to clean resources, but error would be thrown", () => {
        ...
        acquiredDynamicViewComponentRef.clear.and.throwError(
          new Error("Error"),
        );
