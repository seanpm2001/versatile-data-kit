...
describe("DynamicComponentsService", () => {
  ...
  let containerComponentRefStub: jasmine.SpyObj<
    ComponentRef<DynamicContainerComponent>
  >;
  ...
  let contextComponentRefStub: jasmine.SpyObj<
    ComponentRef<DynamicContextComponent>
  >;
  ...
  beforeEach(() => {
    appRootViewContainerRefStub = jasmine.createSpyObj<ViewContainerRef>(
      "appRootViewContainerRefStub",
      ["createComponent", "clear"],
    );

    containerChangeDetectorRefStub = jasmine.createSpyObj<ChangeDetectorRef>(
      "dynamicContainerChangeDetectorRefStub",
      ["detectChanges"],
    );
    containerViewContainerRefStub = jasmine.createSpyObj<ViewContainerRef>(
      "dynamicContainerViewContainerRefStub",
      ["createComponent", "clear"],
    );
    containerComponentHostViewStub = jasmine.createSpyObj<ViewRef>(
      "containerComponentHostViewStub",
      ["destroy"],
      {
        destroyed: false,
      },
    ...
    containerComponentRefStub = jasmine.createSpyObj<
      ComponentRef<DynamicContainerComponent>
    >("dynamicContainerComponentRefStub", ["destroy"], {
    ...
    contextChangeDetectorRefStub = jasmine.createSpyObj<ChangeDetectorRef>(
      "dynamicContextChangeDetectorRefStub",
      ["detectChanges"],
    );
    contextViewContainerRefStub = jasmine.createSpyObj<ViewContainerRef>(
      "dynamicContextViewContainerRefStub",
      ["createComponent", "clear"],
    );
    contextComponentHostViewStub = jasmine.createSpyObj<ViewRef>(
      "contextComponentHostViewStub",
      ["destroy"],
      {
        destroyed: false,
      },
    );
    contextComponentRefStub = jasmine.createSpyObj<
      ComponentRef<DynamicContainerComponent>
    >("dynamicContextComponentRefStub", ["destroy"], {
    ...
    describe("Properties::", () => {
      describe("|CLASS_NAME|", () => {
        it("should verify the value", () => {
          // Then
          expect(DynamicComponentsService.CLASS_NAME).toEqual(
  ...
  describe("Methods::", () => {
    describe("|initialize|", () => {
      const parameters: Array<[string, ViewContainerRef]> = [
        ...
        [
          "ViewContainerRef",
          jasmine.createSpyObj<ViewContainerRef>("viewContainerRefStub", [
            "createComponent",
          ]),
        ],
      ];
    ...
    describe("|getUniqueViewContainerRef|", () => {
      it("should verify will return null, when there is no app root ViewContainerRef", () => {
        ...
        const viewContainerRef2 = service.getUniqueViewContainerRef(
          CollectionsUtil.generateUUID(),
        );
      ...
      it("should verify will return null, when trying to create DynamicContainerComponent, but factory throws error", () => {
        ...
        appRootViewContainerRefStub.createComponent.and.throwError(
          new Error("error"),
        );
        ...
        expect(
          appRootViewContainerRefStub.createComponent,
        ).toHaveBeenCalledWith(DynamicContainerComponent as any);
      ...
      it("should verify will return null, when DynamicContainerComponent is created but validation fail, ViewContainerRef is missing", () => {
        ...
        appRootViewContainerRefStub.createComponent.and.returnValue(
      ...
      it("should verify will return null, when trying to create DynamicContextComponent, but factory throws error", () => {
        ...
        ).toHaveBeenCalledWith(DynamicContextComponent as any);
        expect(consoleErrorSpy).toHaveBeenCalledWith(
      ...
      it("should verify will retrieve existing uuid, ViewContainerRef and ViewRef", () => {
        ...
        expect(
          contextChangeDetectorRefStub.detectChanges,
        ).toHaveBeenCalledTimes(2);
      });
    });
    ...
    describe("|destroyUniqueViewContainerRef|", () => {
      ...
      it("should verify will return false if destroying ViewContainerRef throws error", () => {
        ...
        expect(service["_uniqueComponentRefsStore"].get(uuid)).toEqual(
          contextComponentRefStub,
        );
    ...
    describe("|ngOnDestroy|", () => {
      ...
      it(`should verify won't throw error when invoked and there is error thrown inside`, () => {
        ...
        spyOn(CollectionsUtil, "generateUUID").and.returnValues(
          uuid1,
          uuid2,
          uuid3,
        );
