    ...
    describe("Methods::()", () => {
      ...
      describe("|isStringWithContent|", () => {
        it("should verify if string", () => {
          ...
          expect(
            CollectionsUtil.isStringWithContent(testObj.arrEmpty),
          ).toBeFalsy();
          expect(CollectionsUtil.isStringWithContent(testObj.obj)).toBeFalsy();
          expect(
            CollectionsUtil.isStringWithContent(testObj.objNoProp),
          ).toBeFalsy();
          expect(
            CollectionsUtil.isStringWithContent(testObj.undef),
          ).toBeFalsy();
          expect(
            CollectionsUtil.isStringWithContent(testObj.nullVal),
          ).toBeFalsy();
          ...
          expect(
            CollectionsUtil.isStringWithContent(testObj.weakMap),
          ).toBeFalsy();
      ...
      describe("|generateObjectUUID|", () => {
        it("should verify will generate ObjectUUID in expected format", () => {
          ...
          const spyGenerateUUID = spyOn(
            CollectionsUtil,
            "generateUUID",
          ).and.returnValue(uuid);
